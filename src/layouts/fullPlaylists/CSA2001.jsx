  ...
  return (
    <div className={style['container']}>
      ...
      <div className={style['container-card']}>
        ...
        <Link to='https://youtube.com/playlist?list=PLEJXowNB4kPy3_qhGksOO8ch_Di7T8_9E&si=6M4cScx8cpZcWBfA' target='_blank'><Card color='#8b72ee' image='⚡' heading='Playlist 2' text='Take syllabus with you and study topic wise' width='285' height='240' colorHeading='#FFFFFF' colorText='#FFFFFF' cursor='pointer'/></Link>
      </div>
    </div>
  )
}
