  ...
  return (
    <div className={style['container']}>
        <div className={style['card-container']}>
            <Card color='#29b7dd' image='⚡' heading='EEE1001' text='EEE' width='285' height='240' colorHeading='#FFFFFF' colorText='#FFFFFF' cursor='pointer'/>
            <Card color='#8b72ee' image='∭' heading='MAT1001' text='CALCULAS AND LAPLACE TRANSFORM' width='285' height='240' colorHeading='#FFFFFF' colorText='#FFFFFF' cursor='pointer'/>
            ...
            <Card color='#5d3be7' image='🤖' heading='CSA2001' text='FUNDAMENTALS IN AI & ML' width='285' height='240' colorHeading='#FFFFFF' colorText='#FFFFFF' cursor='pointer'/>
            ...
            <Card color='#bd72ef' image='🖥️' heading='ECE2002' text='DIGITAL LOGIC DESIGN' width='285' height='240' colorHeading='#FFFFFF' colorText='#FFFFFF' cursor='pointer'/>
